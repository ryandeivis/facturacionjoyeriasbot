...
# Intentar importar FastAPI y httpx
try:
...
class TestMetricsEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_metrics_prometheus_endpoint(self, client):
...
class TestOrganizationService:
    ...
    async def test_list_organizations_empty(self, service):
        ...
        with patch('src.database.connection.get_async_db') as mock_db:
            ...
            mock_db.return_value = mock_async_db()
...
class TestInvoiceAPIService:
    ...
    async def test_list_invoices_empty(self, service):
        ...
        with patch('src.database.connection.get_async_db') as mock_db:
            ...
            with patch('src.database.queries.get_invoices_by_org_async', new_callable=AsyncMock) as mock_query:
